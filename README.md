...
CREATE TABLE IMAGES (
    ...
    IMAGE_NAME VARCHAR(255), -- e.g. "Charlotte's Web Page 1"
    IMAGE_PATH VARCHAR(512), -- e.g. "/images/charlottes_web/page1.jpg"
    PARENT_FOLDER VARCHAR(255), -- e.g. "Charlotte's Web"
